...
.form({
  ...
  fields : {
    ...
    'add_opening_fares':{// 开票价
        identifier  : 'add_opening_fares',
        rules: [
          {
              type   : 'regExp[/^[0-9]+([.]{1}[0-9]{1,2})?$/g]',
              prompt : '请输入正整数或者小数(限两位小数)'
    ...
    'add_selling_price':{// 销售价
        identifier  : 'add_selling_price',
        rules: [
          {
              type   : 'regExp[/^[0-9]+([.]{1}[0-9]{1,2})?$/g]',
              prompt : '请输入正整数或者小数(限两位小数)'
    ...
    'add_insurable_value':{// 保险价值
        identifier  : 'add_insurable_value',
        rules: [
          {
              type   : 'regExp[/^[0-9]+([.]{1}[0-9]{1,2})?$/g]',
              prompt : '请输入正整数或者小数(限两位小数)'
        ...
        rules: [
          {
              ...
              prompt : '请按正确的开票时间格式输入 如2017-01-01 23:59:59'
          }
        ]
    },
    'add_modification_time':{//修改时间
        ...
        rules: [
          {
              type : 'regExp[/^(?:(?!0000)[0-9]{4}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-8])|(?:0[13-9]|1[0-2])-(?:29|30)|(?:0[13578]|1[02])-31)|(?:[0-9]{2}(?:0[48]|[2468][048]|[13579][26])|(?:0[48]|[2468][048]|[13579][26])00)-02-29)\\s(?:(?:[0-2][0-3])|(?:[0-1][0-9])):[0-5][0-9]:[0-5][0-9]$/]',
              prompt : '请按正确的修改时间格式输入 如2017-01-01 23:59:59'
          }
        ]
    },
    ,
