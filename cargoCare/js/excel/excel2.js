            ...
            success: function (e) {
                if (e.status == 200) {
                    ...
                    for (i = 0; i < _data.length; i++) {
                        ...
                        $(".fileMsg").append('<tr file="' + e.data[0].filePath + '" T_title="0" condition="1"><td class="first_td">' + _data[i] + '</td><td><input type="text" class="destinations text_all_one" style="color:#999;"  value="' + _data[i] + '"/></td><td><input type="text" style="color:#999;" readonly="true" class="destinationss text_all_two" value="' + _datas[i] + '"></td><td class="flexCenter padding0 set"></td></tr>')
