...
.form({
  ...
  fields : {
    ...
    'edit_waybill_number_three_code':{//运单号三字代码
        ...
        rules: [
          {
              type : 'regExp[/^[0-9A-Z]{3}$/]',
              prompt : '请输入正确的运单号三字代码)'
          }
        ]
    },
    ...
    'edit_billing_time':{//开票时间
        ...
        rules: [
          {
              type : 'regExp[/^(?:(?!0000)[0-9]{4}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-8])|(?:0[13-9]|1[0-2])-(?:29|30)|(?:0[13578]|1[02])-31)|(?:[0-9]{2}(?:0[48]|[2468][048]|[13579][26])|(?:0[48]|[2468][048]|[13579][26])00)-02-29)\\s(?:(?:[0-2][0-3])|(?:[0-1][0-9])):[0-5][0-9]:[0-5][0-9]$/]',
              prompt : '请按正确的开票时间格式输入 2017-01-01 23:59:59'
          }
        ]
    },
...
// //开单费用
// $('.ui.form.add_billing_expenses')
// .form({
//   inline : true,
//   on     : 'blur',
//   fields : {

//     'billing_expenses_cost_name':{//费用名称
//         identifier  : 'billing_expenses_cost_name',
//         rules: [
//           {
//               type   : 'regExp[/([^\s])/]',
//               prompt : '请输入费用名称'
...
//         ]
//     },
//     'billing_expenses_payment_unit':{//付款单位
//         identifier  : 'billing_expenses_payment_unit',
//         rules: [
//           {
//               type   : 'regExp[/([^\s])/]',
//               prompt : '请输入付款单位'
...
//         ]
//     },
//     'billing_expenses_collecting_unit':{//收款单位
//         identifier  : 'billing_expenses_collecting_unit',
//         rules: [
//           {
//               type   : 'regExp[/([^\s])/]',
//               prompt : '请输入收款单位'
...
//         ]
//     },
//     'billing_expenses_relevance':{//关联性
//         identifier  : 'billing_expenses_relevance',
//         rules: [
//           {
//               type   : 'regExp[/([^\s])/]',
//               prompt : '请输入关联性'
...
//         ]
//     },
//     'billing_expenses_rate':{//费率
//         identifier  : 'billing_expenses_rate',
//         rules: [
//           {
//               type   : 'regExp[/^[0-9]+([.]{1}[0-9]{1,2})?$/g]',
//               prompt : '请输入正整数或者小数(限两位小数)'
...
//         ],
//     },
//     'billing_expenses_absolute_cost':{//绝对费用
//         identifier  : 'billing_expenses_absolute_cost',
//         rules: [
//           {
//               type   : 'regExp[/^[0-9]+([.]{1}[0-9]{1,2})?$/g]',
//               prompt : '请输入正整数或者小数(限两位小数)'
...
//         ],
//     },
//     'billing_expenses_actual_cost':{//实际费用
//         identifier  : 'billing_expenses_actual_cost',
//         rules: [
//           {
//               type   : 'regExp[/^[0-9]+([.]{1}[0-9]{1,2})?$/g]',
//               prompt : '请输入正整数或者小数(限两位小数)'
...
// })
// //拼单明细
// $('.ui.form.add_spelling_details')
// .form({
//   inline : true,
//   on     : 'blur',
//   fields : {
//     'spell_three_code':{//拼单中主单三字代码
...
// })
// //出发到达相关信息
// $('.ui.form.add_departure_relevant_information')
// .form({
//   inline : true,
//   on     : 'blur',
//   fields : {
//     'add_departure_relevant_information_receiver':{//签收人
//         identifier  : 'add_departure_relevant_information_receiver',
//         rules: [
//           {
//               type   : 'regExp[/([^\s])/]',
//               prompt : '请填写签收人'
...
//         ]
//     },
//     'add_departure_relevant_information_receive_number':{//签收件数
//         identifier  : 'add_departure_relevant_information_receive_number',
//         rules: [
//           {
//               type   : 'regExp[/^\\d+$/g]',
//               prompt : '请输入正整数'
...
//         ],
//     },
//     'add_departure_relevant_information_receive_time':{//签收时间
//         identifier  : 'add_departure_relevant_information_receive_time',
//         rules: [
//           {
//               type : 'regExp[/^(?:(?!0000)[0-9]{4}(?:(?:0[1-9]|1[0-2])(?:0[1-9]|1[0-9]|2[0-8])|(?:0[13-9]|1[0-2])(?:29|30)|(?:0[13578]|1[02])31)|(?:[0-9]{2}(?:0[48]|[2468][048]|[13579][26])|(?:0[48]|[2468][048]|[13579][26])00)0229)\\s+(?:(?:[0-2][0-3])|(?:[0-1][0-9]))[0-5][0-9][0-5][0-9]$/]',
//               prompt : '请按正确的签收时间格式输入 20170101 235959'
//           }
//         ]
//     },
// },
...
// })
// //出发到达相关信息
// $('.ui.form.edit_departure_relevant_information')
// .form({
//   inline : true,
//   on     : 'blur',
//   fields : {
//     'edit_departure_relevant_information_receiver':{//签收人
//         identifier  : 'edit_departure_relevant_information_receiver',
//         rules: [
//           {
//               type   : 'regExp[/([^\s])/]',
//               prompt : '请填写签收人'
...
//         ]
//     },
//     'edit_departure_relevant_information_receive_number':{//签收件数
//         identifier  : 'edit_departure_relevant_information_receive_number',
//         rules: [
//           {
//               type   : 'regExp[/^\\d+$/g]',
//               prompt : '请输入正整数'
...
//         ],
//     },
//     'edit_departure_relevant_information_receive_time':{//签收时间
//         identifier  : 'edit_departure_relevant_information_receive_time',
//         rules: [
//           {
//               type : 'regExp[/^(?:(?!0000)[0-9]{4}(?:(?:0[1-9]|1[0-2])(?:0[1-9]|1[0-9]|2[0-8])|(?:0[13-9]|1[0-2])(?:29|30)|(?:0[13578]|1[02])31)|(?:[0-9]{2}(?:0[48]|[2468][048]|[13579][26])|(?:0[48]|[2468][048]|[13579][26])00)0229)\\s+(?:(?:[0-2][0-3])|(?:[0-1][0-9]))[0-5][0-9][0-5][0-9]$/]',
//               prompt : '请按正确的签收时间格式输入 20170101 235959'
